...
public class MainActivityTest {
    ...
    public void testClickCity(){
        ...
        // Verify the ClickedCityActivity shows the correct text
        onView(withId(R.id.city_name_text)).check(matches(withText("You clicked: Edmonton")));

        // Press back and verify main list visible again
